...
Z.a.vis=["google"],function(){var a={};(function(b){Z.__vis=b;Z.__vis.b="vis";Z.__vis.g=!0;Z.__vis.priorityOverride=0})(function(b){var c,d=[];d.push("CSS"===b.vtp_selectorType?b.vtp_elementSelector:"#"+b.vtp_elementId);d.push(b.vtp_outputMethod);"BOOLEAN"==b.vtp_outputMethod&&d.push(b.vtp_onScreenRatio);c=d.join("&");var e=a[c],g=Number(ki());if(e&&250>g-e.time)return e.value;e={time:g,value:null};var h=b.vtp_outputMethod,k=null;if("CSS"==b.vtp_selectorType){var l=gf(b.vtp_elementSelector);l&&0<
l.length&&(k=l[0])}else k=C.getElementById(b.vtp_elementId);if(k)switch(h){case "BOOLEAN":var m=(Number(b.vtp_onScreenRatio)||50)/100;e.value=$h(k)>=m&&!ai(k);break;case "PERCENT":e.value=0,ai(k)||(e.value=Math.round(1E3*$h(k))/10)}a[c]=e;return e.value})}();
