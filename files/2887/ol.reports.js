...
}if(opt.reportType==="special_report"){vars.reportHTML+='<div class="report_type_block report_type_block--special"> '+d+" </div>"
}else{vars.reportHTML+='<div class="report_type_block"> '+d+" </div>"
