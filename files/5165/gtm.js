...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return function(a){var c=",["escape",["macro",126],8,16],";a=parseInt(a.getAttribute(\"data-track-promotion\"),10);var b=",["escape",["macro",128],8,16],";if(!isNaN(a)\u0026\u0026c(b,\"array\")\u0026\u0026b.length\u003Ea)return b=b[a],{id:c(b.promotionInfo.promotionID,\"string\"),name:c(b.promotionInfo.promotionName,\"string\"),position:\"slot\"+a}}})();"]
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return function(d,c){var a=",["escape",["macro",126],8,16],";if(!isNaN(c)\u0026\u0026a(d,\"array\")\u0026\u0026d.length\u003Ec){var b=d[c];return{id:a(b.productInfo.sku,\"string\"),name:a(b.productInfo.productName,\"string\"),brand:a(b.productInfo.brand,\"string\"),variant:a(b.category.productType,\"string\"),price:a(b.price.basePrice,\"number\").toString(),position:\"slot\"+c}}}})();"]
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return function(d,c){var a=",["escape",["macro",125],8,16],",b=",["escape",["macro",127],8,16],",e=",["escape",["macro",35],8,16],";(a=a(d,\"data-track\",c))\u0026\u0026(b=b(a,c))\u0026\u0026e(b)}})();"]
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return function(b){function l(){var b=!0,a={\"page.category.pageType\":[",["escape",["macro",79],8,16],",\"string\"],\"content.attributes.template\":[",["escape",["macro",144],8,16],",\"string\"]},c;for(c in a){var d=a[c][0];var e=a[c][1];d=\"array\"===e\u0026\u0026!0===Array.isArray(d)?d:typeof d===e?d:null;d||(g(\"required\",c),b=!1);\"string\"==a[c][1]\u0026\u00261\u003Ea[c][0].length\u0026\u0026(g(\"empty\",c),b=!1)}return b}function g(a,b){var c;\"required\"==a\u0026\u0026(c=\"Required Field Misspecified\");\"empty\"==a\u0026\u0026(c=\"Missing Value\");c=\"dataLayerError: \"+c+\" (\"+\nb+\")\";console.error(c)}var e=b.getAttribute(\"data-track\"),h=",["escape",["macro",125],8,16],"(b,\"data-track-component\"),a={};if(!1===l())return null;if(\"click\"===e){var k=b.getAttribute(\"data-track-label\")||(b.href\u0026\u0026window.location.hostname!==b.hostname?b.href:null),m=b.getAttribute(\"data-track-category\")||",["escape",["macro",144],8,16],"+\":\"+",["escape",["macro",79],8,16],",f=b.getAttribute(\"data-track-action\");b.getAttribute(\"checked\");h\u0026\u0026!f\u0026\u0026(f=h.getAttribute(\"data-track-component\")+\":\"+e);if(k)return a.event=\"data-track\",a.eventAction=\nf,a.eventCategory=m,a.eventLabel=k,a;console.error(\"dataLayerError: More Arguments Needed (data-track-label)\");return null}if(\"download\"===e)return a.event=\"data-track\",a.eventAction=\"download\",a.category=",["escape",["macro",144],8,16],"+\":\"+",["escape",["macro",79],8,16],",a.eventLabel=b.getAttribute(\"href\"),a}})();"]
    },{
      "function":"__v",
      "convert_undefined_to":"(not set)",
      "vtp_dataLayerVersion":2,
  ...
  "rules":[
    ...
    [["if",19,31,32],["add",17]],
    [["if",19,33,34],["add",18]],
    [["if",12],["add",19,20,21,22,24,25,26,27,28,36,37,38,39,0]],
    [["if",12,36],["unless",35],["add",23]],
    [["if",6,37,38],["add",29]],
    [["if",6,38,39],["add",29]],
    [["if",6,38,40],["add",29]],
    [["if",6,40,41],["add",29]],
    ...
    [["if",12,39],["add",31]],
    [["if",12,40],["add",31]],
    [["if",12],["unless",53,54],["add",1,32,45]],
    [["if",6,47],["add",2]],
    [["if",6,40],["add",33,34,42]],
    [["if",6,49],["add",34,42]],
    [["if",6,56],["add",34]],
    [["if",6,13],["add",34]],
    [["if",6,11],["add",34]],
    ...
    [["if",6,43,60],["add",40]],
    [["if",6,43,61],["add",40]],
    [["if",6,43,62,63],["add",41]],
    [["if",6],["unless",7,53],["add",43]],
    [["if",6,64],["unless",65],["add",44]],
    [["if",6,60],["add",48]],
    [["if",6,61],["add",48]],
    [["if",6,67],["add",48]],
    [["if",9,10],["block",5,11,12,13,32,2,33,42,43,46,47]],
    [["if",10,16],["block",7,14]],
    [["if",12,55],["block",1]],
    [["if",10,66],["block",44]]]
},
...
function Fc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.M[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Hc={},Ic=null,Jc=Math.random();Hc.i="GTM-NWDMT9Q";Hc.Ab="8l2";var Kc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0},Lc="www.googletagmanager.com/gtm.js";var Mc=Lc,Nc=null,Oc=null,Pc=null,Qc="//www.googletagmanager.com/a?id="+Hc.i+"&cv=61",Rc={},Sc={},Tc=function(){var a=Ic.sequence||0;Ic.sequence=a+1;return a};
