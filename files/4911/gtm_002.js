...
V.a.e=["google"],function(){(function(a){V.__e=a;V.__e.g="e";V.__e.h=!0;V.__e.b=0})(function(a){return String(rd(a.vtp_gtmEventId,"event"))})}();V.a.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=Jf(c,"gtm.click");Dh(d)}}(function(b){V.__cl=b;V.__cl.g="cl";V.__cl.h=!0;V.__cl.b=0})(function(b){if(!Kh("cl")){var c=K("document");Sa(c,"click",a,!0);Lh("cl")}z(b.vtp_gtmOnSuccess)})}();
