...
}function RightslinkPopUp(a){var b=encodeURI(a).replace("%2526","%26");
window.open(b,"Rightslink","location=no,toolbar=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=650,height=550")
