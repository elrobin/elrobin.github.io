...
return true;
    ...
    {"name":"OAS (Expandable Hack)","trigger":[{"command":"loadScript","arguments":[{"sequential":false,"scripts":[{"src":"satellite-59f762fd64746d35d2008a9f.js"}]}]}],"scope":{"subdomains":{"exclude":["wwwdemo.sciencemag.org|wwwdev.sciencemag.org|searchqa.sciencemag.org|blogsdev.sciencemag.org|wwwqa.sciencemag.org|search-beta.sciencemag.org|blogsqa.sciencemag.org"]}},"conditions":[function(event,target){
var ret = false;
...
return _satellite.textMatch(_satellite.readCookie("RecommendSubscriptionSubmit"), "true");
    ...
    {"name":"Renewal FB Pixel - Confirmation Pg","trigger":[{"command":"writeHTML","arguments":[{"html":"\u003cnoscript\u003e\u003cimg height=\"1\" width=\"1\" style=\"display:none\"\n  src=\"https://www.facebook.com/tr?id=262033091289127\u0026ev=PageView\u0026noscript=1\"\n/\u003e\u003c/noscript\u003e"}]},{"command":"loadScript","arguments":[{"sequential":false,"scripts":[{"src":"satellite-5b9956ac64746d08a800297f.js"}]}]}],"scope":{"URI":{"include":["/ScienceMattersSeries/confirmation.html"]},"subdomains":{"include":["promo.aaas.org"]}},"event":"pagebottom"},
...
return zip_code;
  ...
  "appVersion": "7QN",
  "buildDate": "2019-07-18 17:28:31 UTC",
  "publishDate": "2019-07-18 17:28:30 UTC"
});
})(window, document);
