...
"resource": {
  ...
  "rules":[
    ...
    [["if",6,14],["add",9,45]],
    [["if",21],["add",10]],
    [["if",19],["add",11,12,13,37,42,0,30,32,33,34,35]],
    [["if",6],["unless",22,23,24],["add",14]],
    [["if",25],["add",15]],
    [["if",6,26],["add",15]],
    [["if",28,29,30,31],["add",16]],
    [["if",1],["add",17,48,49,36]],
    [["if",32],["add",18]],
    [["if",6,33],["add",19]],
    [["if",6,34],["add",20]],
    [["if",6,35],["add",21]],
    ...
    [["if",6,24],["add",54]],
    [["if",9,10],["block",6,9,14,19,20,21,29,40,2,45,48,49,51,52,54]],
