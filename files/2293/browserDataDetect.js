(function(){var nav=window.navigator||{};function ipU()
{function euU(v)
...
var lang=(nav.language||nav.userLanguage||"").toLowerCase().substr(0,2);var url="&OS=" +os() +ipU() +"&JE=" +(((typeof(nav.javaEnabled) !="undefined")&&nav.javaEnabled())?1:0) +(lang?("&UL=" +lang):"") +zpU();if (window.CM8DispatcherApps&&(window.CM8DispatcherApps.length>0))
