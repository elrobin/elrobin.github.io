class listExpander{constructor(name,selector,step,offset){this.name=name;this.itemSelector=selector;this.visible=step;this.step=step;this.moreId='view-more-'+name;this.hideId='hide-'+name;this.allId='view-all-'+name;this.offset=offset;this.debug=false;}
