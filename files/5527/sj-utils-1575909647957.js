...
function hasArticleAccess(){return $('.accessDenialWidget .articleMeta span.accessIcon>img.openAccess, .accessDenialWidget .articleMeta span.accessIcon>img.freeAccess, .accessDenialWidget .articleMeta span.accessIcon>img.fullAccess').length>0;}
...
function closePanel(closePanelString){if(closePanelString)
document.getElementById(closePanelString).style.display='none';}
...
function includeHTML(){$('[include-html]').each(function(){let $div=$(this);$div.load($div.attr('include-html'));});}
