YUI.add('portal2012placeholder', function(Y) {
    ...
    Y.namespace('Plugin').Placeholder = Y.Base.create('placeholder', Y.Plugin.Base, [], {
        ...
        initializer : function () {
            ...
            if (host.getAttribute('central') == "true") {
                setTimeout(function () {
                    //console.log('host 1 focus');
                    host.focus();
                }, 500);
                setTimeout(function () {
                    //console.log('host 2 focus');
                    host.focus();
                }, 1500);
            }
        },
...
}, 'gallery-2012.06.20-20-07' ,{requires:['node', 'base-build', 'plugin', 'classnamemanager', 'attribute-base' ]});