AUI().ready('aui-io-request', function (A) {
        ...
        var MAX_NO_OF_DISPLAY_RESULTS_AT_AUTOCOMPLETE = "maxNoOfDisplayResultsAtAutocomplete";
        var AUTOCOMPLETE_SEARCH_LANGUAGE = "autocompleteSearchLanguage";
        var MIN_SEARCH_CHARS = "minSearchChars";
        var MAX_SEARCH_CHARS = "maxSearchChars";

        var AUTOCOMPLETE_QUERY_HANDLER_PATH = "/portal2012-portlet/html/mainSearch/autoCompleteQueryHandler.jsp";

        var AUI_CHECHBOX_SUFFIX = "Checkbox";
        var COLLECTION_ELEM_NAME_EU_LAW = "SinCollections_0";
        ...
        executeAutocompleteQuery = function (searchText, domain, minSearchChars, maxSearchChars, maxNoOfDisplayResultsAtAutocomplete, autocompleteSearchLanguage, callback) {
        ...
        performAutoCompleteQuery = function (searchText, portletNamespace, callback) {
            ...
            if (searchText != searchBoxPlaceholder) {
                ...
                executeAutocompleteQuery(searchText, domain, minSearchChars, maxSearchChars, maxNoOfDisplayResultsAtAutocomplete, autocompleteSearchLanguage, callback);
            }
        }
    ...
    function addEvent(obj, evType, fn, useCapture) {
        ...
        changeInput = function (value, minSearchChars, element, errorContainerClassName) {
            AUI().use('portal2012labels', function (A) {
                ...
                if (inputLength >= minSearchChars) {
                    ...
                    errorContainer.innerHTML = '<div role="alert" class="search-input-alert minLength">' +
                        A.Portal2012Labels.get('eu.europa.publications.MainSearch.insertMinText', minSearchChars) + '</div>';
                    ...
                    errorContainer.innerHTML = '<div role="alert" class="search-input-alert custom">' +
                        A.Portal2012Labels.get('eu.europa.publications.MainSearch.insertText') + '</div>';
        ...
        submitAdvSearchForm = function (namespace, queryTextParam, minSearchChars, errorContainerClassName, wtFunction) {
            if (validateAdvSearch(namespace, queryTextParam, minSearchChars, errorContainerClassName)) {
                AUI().use('node', 'classnamemanager', 'selector-css3', function (Y) {
                    ...
                    if (searchTerm && typeof wtFunction == 'function') {
                        wtFunction(searchTerm);
                    }
        ...
        submitSearchForm = function (namespace, queryTextParam, minSearchChars, errorContainerClassName, wtFunction) {
