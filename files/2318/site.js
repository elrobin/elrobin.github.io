(function($) {
	...
	/*	$(".ar").addClass("js");*/
		...
		var gadgets = {};
		gadgets['fukushima'] = '<iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="/view/widgets/google-earth.html?url=http://www.declanbutler.info/nucpop/nuclearpopulationanalysis.kmz&amp;lat=48.872892&amp;lng=2.349680&amp;range=11010890"></iframe>';
		gadgets['fukushima-large'] = gadgets['fukushima'].replace('height="350"', 'height="700"');

		$('a[href*="#google-gadget"]').each(function() {
			var matches = /#google-gadget-(.+)/i.exec(this.href);
			if (matches && matches[1] in gadgets) {
				$(this).replaceWith(gadgets[matches[1]]);
			}
		});
